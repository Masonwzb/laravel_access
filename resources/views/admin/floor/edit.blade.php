        ...
        <div class="col-lg-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal" method="post" action="{{ url('admin/floor/'.$fields->floor_id.'') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                 <input type="text" name="floor_name" value="{{ $fields->floor_name }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <select class="form-control m-b" name="admin_id">
                                    ...
                                    @foreach($datas as $v)
                                        <option value="{{ $v->admin_id }}"
                                                @if($fields->admin_id == $v->admin_id)
                                                    selected
                                                @endif
                                        >{{ $v->admin_name }}</option>
                                    @endforeach
