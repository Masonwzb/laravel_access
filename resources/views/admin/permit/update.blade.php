        ...
        <div class="ibox-content">
            <form method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="Permit[user_id]" value="{{ isset(old('Permit')['user_id']) ? old('Permit')['user_id'] :$permit->user->user_no}}">
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-2">
                        <select class="form-control" id="floor" name="floor">
                            ...
                            @foreach($floors as $floor)
                                <option value="{{$floor->floor_id}}" @if($permit->room->floor_id==$floor->floor_id) selected=""@endif >{{$floor->floor_name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <select class="form-control" id="room" name="Permit[room_id]">
                            ...
                            @forelse($room as $r)
                                @if($r->floor_id==$permit->room->floor_id)
                                    @if($r->room_id==$permit->room_id)
                ...
                <div class="form-group"id="data_5">
                    ...
                    <div class="col-sm-3">
                        <div class="input-daterange input-group" id="datepicker">
                            <input type="text" class="input-sm form-control" name="Permit[b_d_time]" value="{{ isset(old('Permit')['b_d_time']) ? old('Permit')['b_d_time'] :$permit->b_d_time}}">
                            <span class="input-group-addon">至</span>
                            <input type="text" class="input-sm form-control" name="Permit[e_d_time]" value="{{ isset(old('Permit')['e_d_time']) ? old('Permit')['e_d_time'] :$permit->e_d_time}}">
                        </div>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <div class="input-group clockpicker" data-autoclose="true">
                            <input type="text" class="form-control" value="{{ isset(old('Permit')['b_hm_time']) ? old('Permit')['b_hm_time'] :$permit->b_hm_time}}" id="start_time" name="Permit[b_hm_time]">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <div class="input-group clockpicker" data-autoclose="true">
                            <input type="text" class="form-control" value="{{ isset(old('Permit')['e_hm_time']) ? old('Permit')['e_hm_time'] :$permit->e_hm_time}}" id="end_time" name="Permit[e_hm_time]">
                            <span class="input-group-addon">
                                    <span class="fa fa-clock-o"></span>
                                </span>
                        </div>
