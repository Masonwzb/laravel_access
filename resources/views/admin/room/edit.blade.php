        ...
        <div class="col-lg-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal" method="post" action="{{ url('admin/room/'.$fields->room_id.'') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                            <input type="text" placeholder="请输入节点名称" value="{{ $fields->room_name }}" name="room_name" class="form-control">
                            </div>
                        </div>
                        ...
                        {{--<div class="form-group"><label class="col-lg-2 control-label">节点状态<br/>选择：</label>--}}
                            ...
                            {{--<div class="col-sm-10">--}}
                                {{--<div class="i-checks"><label> <input type="radio" value="1"--}}
                                                                     {{--@if($fields->room_status == '1')--}}
                                                                     {{--checked--}}
                                                                     {{--@endif--}}
                                                                     {{--name="room_status"> <i></i> 开启 </label></div>--}}
                                {{--<div class="i-checks"><label> <input type="radio" value="0"--}}
                                                                     {{--@if($fields->room_status == '0')--}}
                                                                     {{--checked--}}
                                                                     {{--@endif--}}
                                                                     {{--name="room_status"> <i></i> 关闭 </label></div>--}}
                            {{--</div>--}}
                        {{--</div>--}}

                        <div class="form-group"><label class="col-lg-2 control-label">大楼选择：</label>
                            <div class="col-md-5">
                                <select class="form-control m-b" name="floor_id">
                                    ...
                                    @foreach($datas as $v)
                                        <option value="{{ $v->floor_id }}"
                                                @if($fields->floor_id == $v->floor_id)
                                                    selected
                                                @endif
                                        >{{ $v->floor_name }}</option>
                                    @endforeach
